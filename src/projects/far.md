...
gallery:
  ...
  - image: /assets/images/projects/FAR/FAR1-scores-for-steps.PNG
    alt: 'FAR worksheet, showing the scores for each step'
    caption: 'Entry for each page, or task, in the flow'
  - image: /assets/images/projects/FAR/FAR1-worksheet.PNG
    alt: "Lists of tests for each step/page"
    caption: 'List of tests for each step'
  - image: /assets/images/projects/FAR/FAR1-worksheet-filled.PNG
    alt: 'test details for All actions can be completed with the keyboard'
    caption: 'High level test details'
---
...
**View**: [FAR Introduction](https://docs.google.com/document/d/1NTdiz6gm1d4_DNjWgTb19JftUi8xJb8TdShfIeauXuM/edit?usp=sharing) | [Progressive Checklist](https://drive.google.com/file/d/1Tip2rR7RROfhUZWeTtrvG9oL0Ik5rUeE/view?usp=sharing)
